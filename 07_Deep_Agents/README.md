...
The `workspace/` folder contains files automatically generated by the LLM during execution
(e.g. intermediate notes, plans, and outputs). These files are not manually created and are
included for completeness. For example, folder karla_wellness_challenge which contains her 30-day challenge guide, her daily checkins, plans, progresss_data and weekly_reports.
